...
<head>
    ...
    <meta name="author" content="QDKJCHINA" />
										...
										<div class="form-flex-block">
											<div class="form-inline">
												...
												<div class="form-group">
													<button type="button" class="btn btn-primary btn-sm" v-on:click="getList">搜索</button>
												</div>
												<!-- 加载-开始 -->
												<div v-show="loading">
											...
											<table style="width:100%;margin-top:15px;">
												<tr>
													<td style="vertical-align:top;">
														<a v-show="add" class="btn btn-success btn-sm" v-on:click="goAdd">新增</a>
